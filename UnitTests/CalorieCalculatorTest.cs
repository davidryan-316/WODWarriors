...
namespace UnitTests
{
    public class CalorieCalculatorViewModelTest
    {
        [Fact]
        public void CalorieCalculatorViewModel_Constructor_Properties()
        {
            // Arrange
        ...
        //[Fact]
        //public async Task Calculate_ShouldSetCaloriesNeededAsync()
        //{
        //    // Arrange
        //    var viewModel = new CalorieCalculatorViewModel();
        //    viewModel.Age = 30;
